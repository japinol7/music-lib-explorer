...
class Album(SqlAlchemyBase):
    ...
    track_count_total = sqlalchemy.Column(sqlalchemy.Integer)
    tracks_on_discs = sqlalchemy.Column(sqlalchemy.String)
    disc_count_total = sqlalchemy.Column(sqlalchemy.Integer)
